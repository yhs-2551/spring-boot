...
public class PostOperationControllerTest {
    ...
    public void 특정_사용자의_글작성_테스트() throws Exception {
        ...
        final PostRequest postRequest = PostRequest.builder().title(title).content(content).postStatus(postStatus)
    ...
    public void 특정_사용자의_게시글_수정_테스트() throws Exception {
        ...
        Post savedPost = postRepository.save(Post.builder().user(savedUser).title(title).content(content)
        ...
        PostUpdateRequest postUpdateRequest = new PostUpdateRequest(null, newTitle, newContent, null, null, null,
