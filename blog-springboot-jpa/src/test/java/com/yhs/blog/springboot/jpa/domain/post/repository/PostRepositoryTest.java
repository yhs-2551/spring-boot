...
// //        given
//             Post post =
//                     Post.builder().title("Test Title").content("Test Content").postStatus(PostStatus.PUBLIC).user(user).commentsEnabled(CommentsEnabled.ALLOW).build();
...
//             Post post1 =
//                     Post.builder().title("First Post").content("Content for the first post").postStatus(PostStatus.PUBLIC).user(users.getFirst()).commentsEnabled(CommentsEnabled.ALLOW).build();
//             Post post2 =
//                     Post.builder().title("Second Post").content("Content for the second post").postStatus(PostStatus.PUBLIC).user(users.getFirst()).commentsEnabled(CommentsEnabled.ALLOW).build();
//             Post post3 =
//                     Post.builder().title("Third Post").content("Content for the third post").postStatus(PostStatus.PUBLIC).user(users.getLast()).commentsEnabled(CommentsEnabled.ALLOW).build();
...
//             Post post =
//                     Post.builder().title("First Post").content("Content for the first post").postStatus(PostStatus.PUBLIC).user(user).commentsEnabled(CommentsEnabled.ALLOW).build();
...
// //        given
//             Post post = Post.builder().title("First Post").content("Content for the first post").postStatus(PostStatus.PUBLIC).user(user).commentsEnabled(CommentsEnabled.ALLOW).build();
