...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .headers(headers -> headers.frameOptions(frameOptions -> frameOptions.disable())) // h2-console iframe
                                                                                                  // 사용을 위한 설정
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/*/categories/*/posts").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/*/categories/*/posts/page/*").permitAll()
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .redirectionEndpoint(
                                redirectEndpointConfig -> redirectEndpointConfig.baseUri("/login/oauth2/code/*"))
                        // 인증 성공 시 실행할 핸들러
