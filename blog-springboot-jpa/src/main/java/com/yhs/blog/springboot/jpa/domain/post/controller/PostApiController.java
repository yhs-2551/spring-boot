...
public class PostApiController {
    ...
    public ResponseEntity<ApiResponse> findAllPosts(@PathVariable("blogId") String blogId,
        ...
        Page<PostResponse> postResponses = postService.getPosts(userId, keyword, searchType, categoryUuid, pageable);
    ...
    public ResponseEntity<String> uploadFile(
        ...
        try {
            ...
            } else if (!file.getContentType().startsWith("image/") && file.getSize() > 10 * 1024 * 1024) { // 10MB limit
                                                                                                           // for other
                                                                                                           // files
