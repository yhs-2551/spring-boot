...
public class AuthenticationProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        String BlogIdFromToken = claimsExtractor.getBlogId(token);
        String usernameFromToken = claimsExtractor.getUsername(token);
        Long userIdFromToken = claimsExtractor.getUserId(token);
