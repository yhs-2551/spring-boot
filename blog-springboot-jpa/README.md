...
여러 블로그 플랫폼(티스토리, 네이버 블로그, 워드프레스, 벨로그 등)을 사용하면서 느꼈던 불편했던점을 개선하고, 나만의 기능과 디자인을 구현하기 위해 개발한 개인 블로그 백엔드 시스템입니다. 사용자별 블로그, 게시물 관리, 검색 기능, 카테고리 시스템, 사용자 프로필 업데이트, 이미지/파일 업로드, 성능, 보안 및 권한 관리 등 블로그 플랫폼에 필요한 핵심 기능들을 Spring Boot 기반으로 구현했습니다.
...
이 프로젝트는 개인 프로젝트로, 모든 저작권은 작성자에게 있습니다. 상업적 이용 및 재배포를 금지합니다.

이 프로젝트의 소스 코드 및 문서는 학습 및 참고 목적으로만 사용이 가능합니다. 프로젝트의 일부 또는 전체를 사용하기 위해서는 작성자의 명시적인 허가가 필요합니다.

© 2024 \[작성자명]. All Rights Reserved.
